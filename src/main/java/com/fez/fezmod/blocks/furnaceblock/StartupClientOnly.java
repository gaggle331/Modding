...
public class StartupClientOnly
{
	...
	public static void initClientOnly()
	{
		...
		Item stateTexturedBlock = GameRegistry.findItem("fezmod", "statefurnaceblock");
		ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("fezmod:statefurnaceblock", "inventory");
		final int DEFAULT_ITEM_SUBTYPE = 0;
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(stateTexturedBlock, DEFAULT_ITEM_SUBTYPE, itemModelResourceLocation);
	}
