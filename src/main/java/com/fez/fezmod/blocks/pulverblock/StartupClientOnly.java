...
public class StartupClientOnly
{
	...
	public static void initClientOnly()
	{
		...
		Item pulverBlock = GameRegistry.findItem("fezmod", "pulverblock");
		ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("fezmod:pulverblock", "inventory");
		final int DEFAULT_ITEM_SUBTYPE = 0;
		Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(pulverBlock, DEFAULT_ITEM_SUBTYPE, itemModelResourceLocation);
	}
